    ...
    `(
      <content>
        <div>
          ...
          <Input size={'m'} icon={<Icon isAwesome={true} awesomeClass={'fas fa-search'} size={16} color={'blue'} />} />

          <Input
            size={'l'}
            icon={<Icon isAwesome={true} awesomeClass={'fas fa-search-location'} size={20} color={'grey'} />}
          />

          <Heading size={'l'} color={'black'}>
            Images
          </Heading>
          <Image {...photoProps} width={100} height={300} cover />
          <Image {...photoProps} width={270} height={200} cover />
          <Image {...photoProps} width={100} height={100} />
        </div>
        ...
        <div className="grey">
          ...
          <Input size={'l'} icon={<Icon isAwesome={true} awesomeClass={'fas fa-search'} size={16} color={'white'} />} />
        </div>
      </content>,
    );
  }
